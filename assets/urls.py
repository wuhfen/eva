...
#"""项目增删查改"""
    ...
    url(r'^project_rename/$',pviews.project_rename,name="project_rename"),
    url(r'^project_reparent/$',pviews.project_reparent,name="project_reparent"),
...
#test
    ...
    url(r'^search/$',views.vps_search,name="vps_search"),
